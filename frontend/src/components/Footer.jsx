...
const Footer = () => {
    ...
    return (
        <footer className="footer p-10 bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
                <aside>
                    <h2 className="text-3xl font-bold">ElectroShop</h2>
                    <p className="mt-2">Providing reliable Products since 1994</p>
                </aside>
                <nav>
                ...
                <nav>
                    ...
                    <p className="mt-2"><a href="mailto:codeteria@test.com" className="link link-hover">electroshop@test.com</a></p>
                    <p className="mt-2"><a href="tel:+99999999" className="link link-hover">+99 999 9999 99</a></p>
                </nav>
                <form onSubmit={handleSubscribe}>
                    <h6 className="footer-title text-xl font-semibold">Newsletter</h6>
